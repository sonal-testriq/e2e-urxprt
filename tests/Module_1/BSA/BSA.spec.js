...
//   const post_names = await userBSAPage.postNames.first();
...
test.describe.serial("BSA Tests for User Role", () => {
  ...
  test("TC_BSA_013: Verify Expert user is able to accept a bid", async ({
    expertHomePage,
    expertBSAPage,
  }) => {
    await expertHomePage.gotoBSAViaCard();
    await expertBSAPage.searchFor(bsa_productName);
  ...
  test("TC_BSA_014: Verify Company user is able to accept a bid", async ({
    companyHomePage,
    companyBSAPage,
  }) => {
  ...
  // test("TC_BSA_011: Verify Expert user is able to accept the agreement bid", async ({
  //   expertHomePage,
  //   expertBSAPage,
  // }) => {
  //   await expertHomePage.gotoBSAViaCard();
  ...
  // test("TC_BSA_012: Verify Company user is able to accept the agreement bid", async ({
  //   companyHomePage,
  //   companyBSAPage,
  // }) => {
  //   await companyHomePage.gotoBSAViaCard();
  ...
  // test("TC_BSA_015: Verify user is able to view bids submitted by different user", async ({
  //   userHomePage,
  //   userPage,
  //   userBSAPage,
  // }) => {
